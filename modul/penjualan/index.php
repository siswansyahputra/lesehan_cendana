                                                    ...
                                                    <div class="modal-body">
                                                        <form action="modul/penjualan/aksi.php?aksi=bayar&id=<?= $data['id_penjualan']; ?>" method="post">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="number" class="form-control" id="tunai" name="tunai" placeholder="Contoh: 100.000" oninput="hitungKembalian()">
                                                            </div>
                                                            <div class="mb-3">
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination justify-content-center">
                        ...
                        <li class="page-item <?= $halaman <= 1 ? 'disabled' : ''; ?>">
                            <a class="page-link" href="?module=penjualan&page=<?= $halaman - 1; ?>" aria-label="Previous">
                        ...
                        <?php for ($i = 1; $i <= $total_halaman; $i++) : ?>
                            <li class="page-item <?= $i == $halaman ? 'active' : ''; ?>"><a class="page-link" href="?module=penjualan&page=<?= $i; ?>"><?= $i; ?></a></li>
                        <?php endfor; ?>

                        <!-- Next Button -->
                        <li class="page-item <?= $halaman >= $total_halaman ? 'disabled' : ''; ?>">
                            <a class="page-link" href="?module=penjualan&page=<?= $halaman + 1; ?>" aria-label="Next">
