                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-between">
                                            <span>Rp.</span>
                                            <span><?= $data['tunai']; ?></span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex justify-content-between">
                                            <span>Rp.</span>
                                            <span><?= $data['kembalian']; ?></span>
                                        </div>
                                    </td>
                                    <td><?= $data['catatan'] ?></td>
                                    <td>
                                        <button type="button" class="btn btn-info btn-sm mb-1 mb-1" title="Detail Penjualan" data-bs-toggle="modal" data-bs-target="#detailPenjualan<?= $data['id_penjualan']; ?>">
                                        ...
                                        if ($data['status'] == 'Proses') {
                                        ?>
                                            <a href="main.php?module=tambah-pesanan&transaksi=<?= $data['id_penjualan']; ?>&meja=<?= $data['nama_meja']; ?>" type="button" class="btn btn-primary btn-sm mb-1" title="Tambah Pesanan">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bag-plus-fill" viewBox="0 0 16 16">
                                                    <path fill-rule="evenodd" d="M10.5 3.5a2.5 2.5 0 0 0-5 0V4h5zm1 0V4H15v10a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V4h3.5v-.5a3.5 3.5 0 1 1 7 0M8.5 8a.5.5 0 0 0-1 0v1.5H6a.5.5 0 0 0 0 1h1.5V12a.5.5 0 0 0 1 0v-1.5H10a.5.5 0 0 0 0-1H8.5z" />
                                                </svg>
                                            </a>
                                            <button type="button" class="btn btn-success btn-sm mb-1" title="Bayar Penjualan" data-bs-toggle="modal" data-bs-target="#bayarPenjualan<?= $data['id_penjualan']; ?>">
                                        ...
                                        ?>
                                        <button type="button" class="btn btn-warning btn-sm mb-1" title="Cetak Pesanan" data-bs-toggle="modal" data-bs-target="#cetakPesanan<?= $data['id_penjualan']; ?>">
                                        ...
                                        if ($data['status'] == 'Proses') {
                                        ?>
                                            <button type="button" class="btn btn-danger btn-sm mb-1" title="Hapus Penjualan" onclick="hapusPenjualan(<?= $data['id_penjualan']; ?>)">
                                        ...
                                        <div class="modal fade" id="bayarPenjualan<?= $data['id_penjualan']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal fade" id="cetakPesanan<?= $data['id_penjualan']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Cetak Pesanan</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="d-flex justify-content-center gap-2">
                                                            <button class="btn btn-info" onclick="cetakPesanan('<?= $data['id_penjualan']; ?>')">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-printer-fill" viewBox="0 0 16 16">
                                                                    <path d="M5 1a2 2 0 0 0-2 2v1h10V3a2 2 0 0 0-2-2zm6 8H5a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1" />
                                                                    <path d="M0 7a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2h-1v-2a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v2H2a2 2 0 0 1-2-2zm2.5 1a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1" />
                                                                </svg>
                                                                Cetak Makanan & Minuman
                                                            </button>
                                                            <button class="btn btn-success" onclick="cetakStruk(<?= $data['id_penjualan']; ?>)">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-printer-fill" viewBox="0 0 16 16">
                                                                    <path d="M5 1a2 2 0 0 0-2 2v1h10V3a2 2 0 0 0-2-2zm6 8H5a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1" />
                                                                    <path d="M0 7a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2h-1v-2a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v2H2a2 2 0 0 1-2-2zm2.5 1a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1" />
                                                                </svg>
...
<script>
    ...
    function cetakPesanan(id) {
        const printWindow = window.open(`modul/penjualan/cetak_pesanan.php?id=${id}`, '_blank');
        printWindow.focus();
    }
