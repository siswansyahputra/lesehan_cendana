            ...
            <div class="card shadow">
                <div class="card-body">
                    <div class="d-flex justify-content-between flex-wrap">
                        ...
                        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#tambahMenu">
                            <i class="bi bi-bookmark-plus-fill"></i> Tambah Menu
                        </button>
                    </div>
                    <hr>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span class="badge bg-<?= $data_menu['status'] == 1 ? 'success' : 'danger'; ?>">
                    ...
                    <nav>
                        <ul class="pagination justify-content-center flex-wrap">
                            <?php if ($halaman > 1) : ?>
                                <li class="page-item">
                                    <a class="page-link" href="?module=menu&halaman=<?= $halaman - 1; ?>">&laquo;</a>
                                </li>
                            <?php endif; ?>
                            ...
                            <?php if ($halaman < $total_halaman) : ?>
                                <li class="page-item">
                                    <a class="page-link" href="?module=menu&halaman=<?= $halaman + 1; ?>">&raquo;</a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </nav>
