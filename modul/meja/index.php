<div class="container mt-3">
    <div class="row justify-content-center">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <td><?= htmlspecialchars($data['nama_meja']); ?></td>
                                        <td>
                    ...
                    <nav>
                        <ul class="pagination justify-content-center">
                            <li class="page-item <?= $halaman <= 1 ? 'disabled' : ''; ?>">
                                <a class="page-link" href="?page=<?= max(1, $halaman - 1); ?>">&laquo;</a>
                            </li>
                            ...
                            <li class="page-item <?= $halaman >= $total_halaman ? 'disabled' : ''; ?>">
                                <a class="page-link" href="?page=<?= min($total_halaman, $halaman + 1); ?>">&raquo;</a>
                            </li>
                        </ul>
                    </nav>
                </div>
        ...
        <div class="col-lg-4 col-md-8 col-sm-12 mt-3 mt-lg-0">
            <div class="card shadow-sm">
                <div class="card-body">
